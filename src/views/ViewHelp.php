    ...
    <div class="help" id="up">
      ...
      <section class="help__section" id="admin">
        ...
        <div class="help__block" id="adminAddAccount">
          ...
          <p class="help__text">
            Afin de créer un nouveau compte, il suffit de rentrer un nom, un prénom, adresse e-mail, puis cliquer sur "créer".
      ...
      <section class="help__section" id="tech">
        ...
        <div class="help__block" id="createPartner">
          ...
          <p class="help__text">
            Pour créer le compte d'une franchise, entrer le nom, le prénom, le nom de la franchise, et son adresse e-mail.
            ...
            Puis cliqué sur le bouton "retour".
        ...
        <div class="help__block" id="createClub">
          ...
          <p class="help__text">
            Pour créer un club, aller sur le compte de la franchise souhaitant ajouter un club, puis cliquer sur le bouton "ajouter".
            ...
            Lors de la création du club, entrer le nom, le prénom, le nom du club ainsi que son adresse e-mail (dois être unique) puis cliquer sur le bouton "suivant".
            La page des permissions s'ouvre.
            Remplir les permissions accordées à ce club puis cliquées sur le bouton "créer".
        ...
        <div class="help__block" id="activePartner">
          ...
          <p class="help__text">
            Pour activer le compte d'une franchise, il suffit de se rendre sur le profil concerné, et cliquer sur le bouton "activer".
            Une page de confirmation de changement de statut apparaît, cliquer sur le bouton "confirmer".
          </p>
          <div class="help__icon">
            <span class="help__img-text">version desk :</span>
            <div class="help__img-btn">
        ...
        <div class="help__block" id="activeClub">
          ...
          <p class="help__text">
            Pour activer le compte d'un club, il suffit de se rendre sur le profil concerné, et cliquer sur le bouton "activer".
            Une page de confirmation de changement de statut apparaît, cliquer sur le bouton "confirmer".
        ...
        <div class="help__block" id="modifyPermission">
          ...
          <p class="help__text">
            ...
            En bas de la page se trouve le bouton modifier, cliquer dessus.
            Une nouvelle page s'ouvre avec les anciennes permissions déjà cochées, effectuer les modifications,
            puis cliquer sur le bouton "modifier" qui se trouve en bas de la page.
            Une page de confirmation s'ouvre, cliquer sur le bouton "confirmer".
        ...
        <div class="help__block" id="info">
          ...
          <p class="help__text">
            ...
            puis cliquer sur le bouton "plus d'infos".
      ...
      <section class="help__section" id="user">
        ...
        <ul class="help__features">
          ...
          <li class="help__features-item"><a href="#showProfile" class="help__summary-link">Aperçu des modules lié au compte</a></li>
        </ul>


        <div class="help__block" id="modifyPassword">
          <h4 class="help__subtitle">Modifier mot de passe</h4>
          <p class="help__text">
            Pour modifier la description du profil, cliquer sur le lien réglages, puis modifier mot de passe.
            ...
            Puis cliquer sur le bouton "envoyer". Une fenêtre de notification apparaît, cliquer sur le bouton "retour".
          </p>
        </div>
        ...
        <div class="help__block" id="modifyPicture">
          ...
          <p class="help__text">
            Pour modifier la description du profil, cliquer sur le lien réglages, puis modifier photo.
            Télécharger la photo. La photo ne doit pas dépasser 2Mo, puis cliquer sur envoyer.
